            ...
            keypress: function(e) {
                ...
                if(key == 13){
                    ...
                    if(updated_key_result != original_key_result && updated_key_result != ''){
                        companyKeyResultModelParam.editCompanyKeyResult(editing_key_result_id, updated_key_result, original_key_result);
                        $('#notification_message').text("Your company key result is updated successfully!");
                        $('#notification_modal').modal('show');
                    }
                    else{
                        location.reload();
            ...
            keypress: function(e) {
                ...
                if(key == 13){
                    ...
                    if(updated_objective != original_objective){
                        companyObjectiveModelParam.editCompanyObjective(editing_objective_id, updated_objective, original_objective);
                        $('#notification_message').text("Your company objective is updated successfully!");
                        $('#notification_modal').modal('show');
                    }
                    else{
                        location.reload();
