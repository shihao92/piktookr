class CompanyObjectivesController < ApplicationController
  ...
  def create
    @company_objective = CompanyObjective.new(company_objective_params.merge(progress: 0.0))
  ...
  private
    ...
    def company_objective_params
      ...
      params.require(:company_objective).permit(:objective, :progress, :timeframe_log_id).merge(timeframe_log_id: @log[0].id);
    end
